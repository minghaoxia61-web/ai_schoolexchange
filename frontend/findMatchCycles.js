...
const result = findMatchCycles(mockData, 0.5);
console.log('找到的闭环：', JSON.stringify(result.cycles, null, 2));
console.log('供需关系：', result.supplyDemand);
console.log('性能指标：', result.performance);
